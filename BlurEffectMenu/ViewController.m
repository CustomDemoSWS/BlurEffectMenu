...
#import "BlurEffectMenuViewController.h"//仿钉钉弹出毛玻璃菜单
...
- (void)btnClicked{
    ...
    BlurEffectMenuViewController *menu=[[BlurEffectMenuViewController alloc]initWithMenus:@[addMattersItem,addSchedulesItem,setupChatItem,searchContactsItem]];
